...
bool cmp(boys &c1, boys &c2) {return c1.get_budget() > c2.get_budget();}
bool cmp2(girls &c1, girls &c2) {return c1.get_maintenance() > c2.get_maintenance();}
...
void coupling(vector<boys> (*b) ,vector<girls> (*g),vector< pair<string,string> > (*couples))
{
		...
		cout <<"couples formed and gifting details in log.txt\n";
